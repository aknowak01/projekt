...
const userSchema = new mongoose.Schema({
    ...
    role: {
        type: String, enum: userRoles, default: userRole.admin, required: false,
    },
...
export default {
    createNewOrUpdate: createNewOrUpdate, getByEmailOrName: getByEmailOrName, get: get, removeById: removeById,

    userRole: userRole, model: UserModel,
};
